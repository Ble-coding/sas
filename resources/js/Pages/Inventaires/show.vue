    ...
    <div class="bg-gray-200 px-6 py-4">
      <div class="bg-gray-200 text-gray-700 text-lg px-6 py-4">
       <div class="flex items-center justify-between">
        ...
        <div class="bg-blue-700 w- h-12 flex justify-center items-center rounded-full  uppercase font-bold text-white">{{ inventaire.marque }}</div>
        <div class="ml-4">
...
//,'verouillage'
 ...
 methods: {
    submit: function () {
     this.$inertia.patch('/inventaires/terminer/' + this.inventaireShow.id, this.inventaireShow,  this.inventaireShow.status=1)
    }
  },
    // methods : {
    //   print() {
   
    //  if(verouillageShow = true)
    //     {
    //        verouillageShow.status = 1;
    //     }
